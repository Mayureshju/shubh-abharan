...
export const merchandise: readonly Product[] = [
  {
    ...
    images: [
      {
        ...
        alt: "A gold kundan necklace with emerald drops, laid on cream marble beside a fold of emerald silk.",
      },
      {
        role: "worn",
        aspect: "4/5",
        ...
        position: "72% 40%",
        crop: "necklace on the collarbone against palm foliage",
        alt: "A woman in an emerald silk saree wearing a gold kundan necklace with emerald drops.",
      },
    ],
    ...
    description:
      "A circular kundan necklace with emerald drops, photographed on cream marble beside a fold of emerald silk.",
    care: null,
  },
  {
    ...
    images: [
      {
        ...
        crop: "floral kundan collar on cream marble, square still",
        alt: "A gold kundan collar with emerald stones and pearl drops, laid on cream marble beside emerald silk.",
      },
    ],
    collections: ["modern-classics"],
    ...
    description:
      "A floral kundan collar with a central pendant, pearl drops and emerald stones, laid on cream marble.",
    care: null,
  },
  {
    ...
    images: [
      {
        ...
        crop: "pair of chandbalis on cream marble, square still",
      ...
      },
      {
        ...
        src: "/images/hero-worn.jpg",
        position: "80% 35%",
        crop: "chandbali at the ear against foliage",
        alt: "A woman in an emerald silk saree wearing matching chandbali earrings.",
      },
    ],
    collections: ["modern-classics"],
    occasions: ["wedding"],
    ...
    description:
      "A pair of gold chandbali earrings with emerald drops, laid on cream marble against emerald silk.",
    care: null,
  ...
  },
  {
    ...
    images: [
      {
        ...
        crop: "kundan pendant with emerald drop on cream marble, square still",
        alt: "A gold kundan pendant with an emerald drop on a fine chain, resting on cream marble beside emerald silk.",
      },
    ],
    collections: [],
    occasions: ["everyday"],
    ...
    description:
      "A gold kundan pendant with an emerald drop on a fine chain, resting on cream silk.",
    care: null,
  ...
  },
  {
    ...
    images: [
      {
        ...
        crop: "two stacked rings on cream marble, square still",
        alt: "Two stacked gold rings set with emeralds and uncut diamonds, on cream marble beside emerald silk.",
      },
    ],
    collections: ["modern-classics"],
    occasions: ["festive"],
    ...
    description:
      "Two stacked gold rings set with emeralds and uncut diamonds, photographed on cream linen.",
    care: null,
  },
  {
    ...
    images: [
      {
        ...
        crop: "pair of kundan bangles on cream marble, square still",
        alt: "A pair of gold kundan bangles with emerald stones, resting on cream marble beside emerald silk.",
      },
      {
        role: "worn",
        aspect: "4/5",
        ...
        alt: "Stacked gold bangles worn with an emerald and maroon silk saree in a lamp-lit interior.",
      },
    ],
    collections: [],
    occasions: ["festive", "wedding"],
    ...
    description:
      "A pair of gold kundan bangles with emerald stones, resting on emerald and cream silk.",
    care: null,
  ...
  },
  {
    ...
    images: [
      {
        ...
        src: "/images/hero-worn.jpg",
        position: "72% 40%",
        crop: "necklace, chandbalis and maang tikka worn against foliage",
        alt: "A woman in an emerald silk saree wearing a gold kundan necklace with emerald drops, matching chandbali earrings and a maang tikka.",
      },
      {
        role: "macro",
        aspect: "1/1",
        src: "/images/product-bridal-set.jpg",
        crop: "necklace and chandbalis laid on cream marble, square still",
        alt: "A gold kundan necklace with emerald drops and matching chandbali earrings, laid on cream marble beside emerald silk.",
      },
    ],
    collections: ["modern-classics"],
    occasions: ["wedding"],
    ...
    description:
      "Necklace, matching chandbali earrings and a maang tikka, photographed on emerald silk against palm foliage.",
    care: null,
  ...
  },
  {
    ...
    images: [
      {
        ...
        crop: "pendant on a fine chain, cream marble, square still",
        alt: "A gold kundan pendant with an emerald drop on a fine chain, looping across cream marble beside emerald silk.",
      },
      {
        role: "detail",
        aspect: "1/1",
        ...
        alt: "Close view of a gold disc, its granulated and twisted-wire bezel closed by hand around a deep red garnet cabochon.",
      },
    ],
    collections: [],
    occasions: ["everyday"],
    ...
    description:
      "A pendant on a fine chain, photographed on cream silk — close enough for daily wear.",
    care: null,
