    ...
    images: [
      {
        ...
        crop: "circular kundan necklace with emerald drops, cream marble",
    ...
    images: [
      {
        ...
        crop: "kundan collar with pearl drops on cream marble",
        alt: "A gold kundan necklace with emerald stones and pearl drops, laid across cream marble beside emerald silk.",
      },
    ],
    collections: ["modern-classics"],
    ...
    images: [
      {
        ...
        crop: "pair of chandbalis on cream marble",
    ...
    images: [
      {
        ...
        crop: "kundan pendant with emerald drop on cream silk",
    ...
    images: [
      {
        ...
        crop: "two stacked rings on cream linen",
    ...
    images: [
      {
        ...
        crop: "pair of kundan bangles on silk",
  ...
  },
  {
    ...
    images: [
      ...
      },
      {
        ...
        aspect: "1/1",
        src: "/images/category-necklaces.jpg",
        crop: "necklace still from the set",
        alt: "A circular gold kundan necklace with emerald drops, centred on cream marble.",
      },
    ],
    collections: ["modern-classics"],
    occasions: ["wedding"],
    ...
    images: [
      {
        ...
        aspect: "1/1",
        src: "/images/category-pendants.jpg",
        crop: "pendant on a fine chain, cream silk",
        alt: "A gold kundan pendant with an emerald drop on a fine chain, resting on cream silk.",
      },
      {
        role: "detail",
