 ...
 */
const CONTRAST = [
  { pair: "charcoal on paper", ratio: "16.19:1", floor: "4.5:1", use: "body and caption text" },
  { pair: "graphite on paper", ratio: "10.18:1", floor: "4.5:1", use: "secondary text" },
  { pair: "lilac on paper", ratio: "5.84:1", floor: "4.5:1", use: "accent text (eyebrows, legends)" },
  { pair: "paper on ink", ratio: "12.51:1", floor: "4.5:1", use: "body text on aubergine" },
  { pair: "graphite-inverse on ink", ratio: "8.18:1", floor: "4.5:1", use: "secondary text on aubergine" },
  { pair: "charcoal on lavender", ratio: "6.79:1", floor: "4.5:1", use: "primary button label" },
  { pair: "charcoal on gold", ratio: "7.22:1", floor: "4.5:1", use: "quiet button hover label" },
  { pair: "gold on ink", ratio: "5.58:1", floor: "4.5:1", use: "accent text, rules and icons on aubergine" },
  ...
  return (
    ...
    <div className="page-gutter">
        ...
        <Section
          ...
          intent="Ivory paper, charcoal text, aubergine inverted surface, lavender fill, soft-gold ornament. Accent text is deep lilac on paper and gold on aubergine."
        >
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {[
              { name: "paper", cls: "bg-paper", token: "Ivory #FAF6EF" },
              { name: "charcoal", cls: "bg-charcoal", token: "Charcoal #1A1A1A" },
              { name: "ink", cls: "bg-ink", token: "Aubergine #372849" },
              { name: "lavender", cls: "bg-lavender", token: "Logo lilac #AE96DA" },
              { name: "lilac", cls: "bg-lilac", token: "Deep lilac #6D5398" },
              { name: "gold", cls: "bg-gold", token: "Soft gold #C6A264" },
            ].map((swatch) => (
              <div key={swatch.name}>
        ...
        <Section
          ...
          rhythm="tight"
          intent="One of exactly two surfaces — aubergine. Secondary text resolves to graphite-inverse here automatically."
          surface="ink"
        >
